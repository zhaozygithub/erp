...
public class BankUtil {
	...
	// "发卡行.卡种名称",
	private static final String[] bankName = { "邮政储蓄银行·绿卡通", "邮政储蓄银行·绿卡银联标准卡", "邮政储蓄银行·绿卡银联标准卡", "邮政储蓄银行·绿卡专用卡", "邮政储蓄银行·绿卡银联标准卡",
			"邮政储蓄银行·绿卡(银联卡)", "邮政储蓄银行·绿卡VIP卡", "邮政储蓄银行·银联标准卡", "邮政储蓄银行·中职学生资助卡", "邮政储蓄银行·IC绿卡通VIP卡", "邮政储蓄银行·IC绿卡通",
			"邮政储蓄银行·IC联名卡", "邮政储蓄银行·IC预付费卡", "邮政储蓄银行·绿卡银联标准卡", "邮政储蓄银行·绿卡通", "邮政储蓄银行·武警军人保障卡", "邮政储蓄银行·中国旅游卡（金卡）",
	...
	public static void main(String[] args) {
		String name = getname("6217921970608090");// 获取银行卡的信息
