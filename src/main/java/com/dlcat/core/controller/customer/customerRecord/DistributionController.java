...
public class DistributionController extends BaseController {
	public void index(){
		...
		tableHeader.setFieldNames(new String[]{"id","name","phone","cn_type","belong_user_id","belong_user_name","belong_org_id","belong_org_name","cn_cu_status_remark"});
		tableHeader.setCNNames(new String []{"客户编号","名称","电话号码","客户类型","管户人编号","管户人名称","管户机构编号","管户机构名称","客户状态备注"});
		//多选框
		...
		try {
			...
			//excel文件的文件名称
			response = PageUtil.createTablePageStructure("/distribution/data", "正式客户分配表数据", tableHeader, 
...
//		formFieldList.add(new FormField("belong_user_id", "管户人编号", "text"));
		...
		DyResponse response = PageUtil.createFormPageStructure("正式客户分配添加", formFieldList, "toAdd");
		this.setAttr("response", response);
