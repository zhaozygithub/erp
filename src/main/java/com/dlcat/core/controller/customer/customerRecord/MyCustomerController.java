...
public class MyCustomerController extends BaseController {
	...
	public void index() {
		...
		try {
			...
			response = PageUtil.createTablePageStructure(
					"/myCustomer/data", "我的客户列表数据", tableHeader, search,
	...
	public void toAdd() {
		...
		cuObjectCustomer.set("belong_user_name",user.getStr("name"));
		cuObjectCustomer.set("belong_org_id", user.getInt("belong_org_id"));
